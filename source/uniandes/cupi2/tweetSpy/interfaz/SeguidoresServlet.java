...
public class SeguidoresServlet extends TemplateServlet 
{
			...
			HttpServletResponse response) throws IOException 
	{
		...
		try{
		lista = instancia.darListaSeguidores();
		...
		for (int i = 0; i<lista.darTamanio(); i++)
		{
			...
			respuesta.write("		<td><b>"+n+"</b><p><b>Descripcion:</b></p><p>"+descr+"</p></td>\r\n");
			respuesta.write("	</tr>\r\n");
		}
			respuesta.write("<tr>\r\n");
			...
			respuesta.println("		  <li class=\"active\"><a href=\"seguidores\">Followers</a></li>");
