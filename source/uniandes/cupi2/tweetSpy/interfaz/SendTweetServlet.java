...
public class SendTweetServlet extends TemplateServlet
{
	//------------------------------------------------
			...
			HttpServletResponse response) throws IOException 
	{
		...
		String trinacion = request.getParameter( "trinacion" );
		if (!trinacion.equals("") && trinacion != null)
		{
			try {
				instancia.enviarTrino(trinacion);
				
				PrintWriter respuesta = response.getWriter( );
				
				respuesta.write("<p> Tweet enviado! </p>");
				...
				respuesta.println("          <li class=\"active\"><a href=\"trinar\">Tweet</a></li>");
