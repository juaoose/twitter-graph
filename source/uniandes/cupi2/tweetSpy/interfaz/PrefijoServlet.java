...
public class PrefijoServlet extends TemplateServlet
{
	//------------------------------------------------
			...
			HttpServletResponse response) throws IOException 
	{
		...
		String palabra = request.getParameter( "prefijo" );
		
		ListaDoblementeEncadenada<Usuario> lista;
		try{
		lista = instancia.darPrefijo(palabra);
		if (lista.darTamanio() < 1)
		{
			...
			respuesta.println("			<h4>No se encontro ningun amigo /seguidor por ese prefijo!</h4>");
			...
			respuesta.println("		  <li class=\"active\"><a href=\"newpre\">Prefijo</a></li>");
