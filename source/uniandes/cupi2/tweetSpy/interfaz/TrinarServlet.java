...
public class TrinarServlet extends TemplateServlet 
{
	...
	public void escribirContenido(HttpServletRequest request,
		...
		respuesta.write("<form method=\"POST\" name=\"input\" action=\"sendtweet\" >");
		respuesta.println("<div class=\"input-append\">");
		respuesta.write("Tweet: <input type=\"text\" class=\"span2\" name=\"trinacion\" maxlength=\"140\">");
