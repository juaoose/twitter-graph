...
public class BusquedaPreServlet extends TemplateServlet
{
	//------------------------------------------------
	...
	public String darTituloPagina(HttpServletRequest request) 
	{
		...
		return nombre+"- Busqueda Prefijo";
	}
	...
	public void escribirContenido(HttpServletRequest request,
		...
		respuesta.write("<form method=\"POST\" name=\"input\" action=\"prefijos\" >");
		respuesta.println("<div class=\"input-append\">");
		respuesta.write("Prefijo: <input type=\"text\" class=\"span2\" name=\"prefijo\" maxlength=\"140\">");
